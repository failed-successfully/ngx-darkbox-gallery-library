...
Darkbox Gallery is a highly configurable lightbox themed gallery library for Angular applications using the ivy engine (Angular 19+).
...
## How?
### Installation
Install npm package for Angular:
