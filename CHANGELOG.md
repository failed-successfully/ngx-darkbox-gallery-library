...
### Changed
* Remove deprecated keyboard navigation binding
* Convert image class to aninterface

## [5.0.1] - 2026-05-13

### Changed
* Updated dependencies (#2195)
...
### Changed
* Update dependencies
* Update publishing workflow to use Trusted Publisher
